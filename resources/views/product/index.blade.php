                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td><img src='{{ asset("storage/uploads/products/{$product->thumbnail}") }}'
                                            ...
                                            <td style="vertical-align: middle;">
                                                <!-- <a class="btn btn-success btn-xs" href="{{ route('category.show', $product->id) }}">
                                                <i class="fas fa-check-square"></i>
                                            </a> -->
                                                <a class="btn btn-warning btn-xs"
                                                    href="{{ route('category.edit', $product->id) }}">
